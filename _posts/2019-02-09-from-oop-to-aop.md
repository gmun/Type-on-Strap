...
AOP는 흔히 마법과 같다고 말한다. 본 포스팅에선 그 이유에 대한 해답이 되길 바란다. Spring Boot 2.0 환경에서 학습을 진행하였고 AOP는 AspectJ로 구현하였다. 또한, 학습 과정에서 사용했던 코드 및 OOP의 디자인과 Bean을 설정하는 자세한 과정은 [GitHub](https://github.com/gmun/fromooptoaop)를 참고하길 바란다.
