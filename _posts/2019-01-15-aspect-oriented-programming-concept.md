...
일반적으로 Aspect를 관점으로 해석하지만, 사전적 의미를 찾아보면 또 다른 의미를 발견할 수 있다.
...
여기까지 AOP의 개념적인 부분과 Spring AOP에 대한 부분도 간략히 포스팅해보았다.

하지만 예제 코드 없이 설명하려 하니 AOP에 처음 접한 분들이라면 오히려 헷갈릴 수 있다고 생각한다. 다음 포스팅에선 이를 해소할 예시 코드와 부분적으로 자세히 풀어갈 예정이다.
